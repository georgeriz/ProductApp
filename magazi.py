...
def _insert_description(product, aFrame):
    ...
    Label(aFrame, text = product.get_price(), foreground = "blue", relief = SUNKEN).grid(row = 2, column = 1, sticky = W)
    if _expert_mode:
        ...
        Label(aFrame, text = product.get_cost(), foreground = "red").grid(row = 4, column = 1, sticky = W)
